        ...
        var _loop = function _loop(x) {
          setTimeout(function () {
            ...
            if (deviceArr.length - 1 === Number(x)) {
              document.getElementById("complete").innerHTML = '<hr/> Done. Min CO2 = ' + Math.min.apply(Math, co2Arr) + ' Max CO2 = ' + Math.max.apply(Math, co2Arr) + ' Average = ' + co2Arr.reduce(function (a, b) {
                return a + b;
              }, 0) / co2Arr.length;
            }
          }, 2000 * x);
...
//# sourceMappingURL=/script.f6ca2d84.js.map